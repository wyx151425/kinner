...
public class KinnerBookStylePickerFragment extends DialogFragment {

    public static final String EXTRA_STYLE = "com.rumofuture.nemo.view.fragment.KinnerBookStylePickerFragment.mStyle";
    ...
    public KinnerBookStylePickerFragment() {
