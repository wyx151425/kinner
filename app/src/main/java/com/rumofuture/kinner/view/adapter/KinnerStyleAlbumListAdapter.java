...
public class KinnerStyleAlbumListAdapter extends RecyclerView.Adapter<KinnerStyleAlbumListAdapter.ItemViewHolder> {

    private List<Album> mAlbumList;
    private Context mContext;

    public KinnerStyleAlbumListAdapter(List<Album> albumList) {
