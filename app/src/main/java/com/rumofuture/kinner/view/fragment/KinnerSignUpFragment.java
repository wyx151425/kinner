...
public class KinnerSignUpFragment extends Fragment implements KinnerSignUpContract.View {

    private KinnerSignUpContract.Presenter mPresenter;
    ...
    public KinnerSignUpFragment() {

    }

    public static KinnerSignUpFragment newInstance() {
        return new KinnerSignUpFragment();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        mProgressBar = KinnerProgressBarFragment.newInstance(getString(R.string.prompt_signing_up));
    ...
    @Override
    public void setPresenter(KinnerSignUpContract.Presenter presenter) {
