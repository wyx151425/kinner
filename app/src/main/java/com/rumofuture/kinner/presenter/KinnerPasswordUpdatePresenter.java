...
public class KinnerPasswordUpdatePresenter implements KinnerPasswordUpdateContract.Presenter {

    private KinnerPasswordUpdateContract.View mView;

    private Handler mHandler;
    private int requestedTime;

    public KinnerPasswordUpdatePresenter(KinnerPasswordUpdateContract.View view) {
        mView = view;
        start();
    }
