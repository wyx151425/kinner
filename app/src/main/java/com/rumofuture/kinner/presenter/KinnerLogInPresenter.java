...
public class KinnerLogInPresenter implements KinnerLogInContract.Presenter, UserDataSource.UserLogInCallback {

    private KinnerLogInContract.View mView;
    private UserDataSource mUserRepository;

    public KinnerLogInPresenter(KinnerLogInContract.View view, UserDataSource userRepository) {
        mView = view;
